...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 26.9.1.1](https://img.shields.io/badge/AppVersion-26.9.1.1-informational?style=flat-square)
...
The following table lists the main configurable parameters of the librenms chart and their default values. Please, refer to [values.yaml](./values.yaml) for the full list of configurable parameters.
...
| librenms.image.tag | string | `"26.9.1.1"` | tag is image tag to pull. |
